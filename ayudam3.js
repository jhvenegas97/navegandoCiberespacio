...
lib.ssMetadata = [
		{name:"ayudam3_atlas_", frames: [[275,1041,307,239],[628,622,303,267],[628,891,330,239],[0,1041,273,274],[0,622,626,417],[0,0,1009,620]]}
];
...
(lib.actividades = function() {
	this.initialize(ss["ayudam3_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.ayudam3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedTexturedBitmap_524.png?1595387866643", id:"CachedTexturedBitmap_524"},
		{src:"images/CachedTexturedBitmap_525.png?1595387866643", id:"CachedTexturedBitmap_525"},
		{src:"images/ayudam3_atlas_.png?1595387866617", id:"ayudam3_atlas_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1595387866643", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1595387866643", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1595387866643", id:"an.Video"}
	],
	preloads: []
};
