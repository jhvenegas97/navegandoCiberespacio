...
lib.ssMetadata = [
		{name:"ayudam4_atlas_", frames: [[275,1041,307,239],[628,622,303,267],[628,891,330,239],[0,1041,273,274],[0,622,626,417],[0,0,1009,620]]}
];
...
(lib.actividades = function() {
	this.initialize(ss["ayudam4_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.ayudam4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
		...
		function moverse(e){
			switch(e.name){
				...
				case "actividades":
					...
					break;
				case "ayuda":
					window.open("./ayudam4.html", "_self");
					break;
			}
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedTexturedBitmap_543.png?1595388056813", id:"CachedTexturedBitmap_543"},
		{src:"images/CachedTexturedBitmap_544.png?1595388056813", id:"CachedTexturedBitmap_544"},
		{src:"images/ayudam4_atlas_.png?1595388056793", id:"ayudam4_atlas_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1595388056813", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1595388056813", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1595388056813", id:"an.Video"}
	],
	preloads: []
};
